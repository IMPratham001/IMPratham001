...
![Avalonia](https://img.shields.io/badge/Avalonia-8B44AC?style=for-the-badge&logo=dotnet&logoColor=white)
...
### 🎓 CampusIq
Full campus-management platform — web dashboard + Flutter mobile app, PostgreSQL backend.
...
### 🛒 NutriVault
Modern e-commerce storefront with a full product & checkout flow.
...
### 🎮 Games-Suite
A collection of browser games built with a shared React/TS engine.

`TypeScript` · `React` · `Canvas`

[![Repo](https://img.shields.io/badge/Code-0d1117?style=flat-square&logo=github&logoColor=white)](https://github.com/IMPratham001/Games-Suite)

</td>
<td width="50%" valign="top">

### 👥 Tomodachi
A social experience app — connect, share, and stay in touch.

`Next.js` · `TypeScript`

[![Repo](https://img.shields.io/badge/Code-0d1117?style=flat-square&logo=github&logoColor=white)](https://github.com/IMPratham001/tomodachi)
...
<picture>
  ...
  <img alt="contribution snake" src="https://raw.githubusercontent.com/IMPratham001/IMPratham001/output/github-contribution-grid-snake-dark.svg" />
</picture>
